...
UserModel userModel = (UserModel) ScenarioContext.getScenarioInstance().setContext(USER_MODEL); (сох в enum class)

UserModel userModel = (UserModel) ScenarioContext.getScenarioInstance().getContext(USER_MODEL);
 */